                    ...
                    <div className="_content-block">
                        ...
                        <span>
                            <p>
                                ...
                                It's easy to remember that your <strong>Bas</strong>al insulin is your <strong>base</strong> rate of insulin and it comes in a few different durations. It's important to check the pamphlet or insert that comes with your insulin to determine the onset, peak and duration.
                                <br/>
                                <br/>
                                Bolus insulin is your rapid acting insulin that you take with meals.
                                This one is much stronger because it's formulated to help us deal with the glucose spikes that come with eating. We'll explore this a bit later on. 
                                <br/>
                                <br/>
                                <span style={{textDecoration: "underline"}}>Insulin Delivery Methods</span>
                                <br/>
                                While there is an inhalable insulin, by far the most common delivery method for insulin is subcutaneous injection.
                                ...
                                These fancy pens usually need to have the ability to be refilled rather than disposed of because they do more than just inject you with lifejuice. The most common feature you will find is an injection history, which will help you remember when and how much you last injected.
                                <br/>
                                <br/>
                                If you're on a pump, (admittedly I am not so I don't have a lot of experience with them) you will basically have a catheter (IV?) that you move around once every few days.
                                ...
                                <br/>
                                <br/>
                                <span style={{textDecoration: "underline"}}>Glucometers</span>
                                <br/>
                                There are two types of Glucometers you're likely to run into nowadays. The first are just simply called 'glucometers' and they're what you might be more familiar with and even if you primarily use the second type, you should always have one of these as a back up.
                                ...
                                <br/>
                                <br/>
                                <span style={{textDecoration: "underline"}}>Special Mentions</span>
                                <br/>
                                There is a lot more to discuss in the above topics like syringe and needle gauge and lengths, cgm brands and overpatches, even different types of insulin but we'll discuss those another time.
                                I wanted to take some time out however to mention a few other things I've personally found very handy. 
                                <br/>
                                <br/>
                                Cheap Kitchen Scale: A cheap unit from your preferred source is sufficient. It's best to get one that can measure down to 0.1 grams for measuring cereal, yogurt, milk, chips, fruit, just about anything you're going to need to measure in the kitchen really.
                                <br/>
                                <br/>
                                Fanny Pack / Lunch Bag: Especially if you don't have a backpack or a purse, these are great to carry your insulin, low snacks, glucometer and room for whatever else you might want.
                                <br/>
                                <br/>
                                iPort Advanced: In the way that a CGM reduces finger pricks, the iPort Advanced reduces injections. It's an empty reservoir that you implant into yourself. Then you fill the reservoir instead of taking injections.
                    ...
                    <div className="_content-block">
                        ...
                        <span>
                            <p>
                                ...
                                <br/>
                                <br/>
                                Ideally speaking, your basal rate will hold you at around 6mmol / 108mg.
                                Now you might be thinking to yourself, 'but but but, a nondiabetic averages 4.5mmol/81mg!' yes, dear reader they do. If you were to hold yourself to that level however, you would have a much smaller margin of error. 
                                By staying a bit higher but still within safe ranges we reduce our chance for diabetic complications from both lows and highs. 
                                Does that mean it's unachievable for a diabetic? Absolutely not. You could certainly match those numbers. 
                                It just requires a lot more upkeep and maintenance and a strong understanding of your disease and your body.
                                <br/>
                                <br/>
                                A common misconception between the two types of diabetes is that while a Type 2 Diabetic may struggle to keep their sugar levels down a Type 1 Diabetic generally speaking will struggle to keep their sugar levels up.
                                That is usually due in part to having an incorrect basal dosage.
                                If your basal dosage is off all of your other dosages will also be off, so it's important to watch for patterns so that you can make the necessary adjustments.
                                If you are having two or more high or low blood sugar readings a day, you may need to adjust your basal rate.
                                <br/>
                                <br/> 
                                If your basal rate is too high, your insulin-to-carb ratio should be lowered until you can adjust your basal rate. 
                                <br/>
                                If your basal rate is too low, you will likely need to increase your I:C ratio until you can adjust your basal rate. 
                                <br/>
                                <br/>
                                To perform a basal rate test, you need to have an empty stomach because we don't want to introduce any new glucose sources. 
                                We're trying to measure how our body is utilizing glucose, so if we're actively digesting food our data will be skewed.
                                It is recommended to not eat for at least 4-5 hours prior to performing a basal rate test. 
                                Additionally, your blood sugar should be between approximately 5.5mmol/100mg and 8mmol/145mmol. 
                                This is so that during the testing our blood sugar does not drop too low or rise too high. 
                                If your blood sugar goes outside of your acceptable range (generally considered between 4.5mmol/81mg and 10mmol/180mg) during your testing it is important to immediately stop the test and treat appropriately. 
                                <br/>
                                <br/>
                                It is important to remember that though we call this a test, there is no pass/fail.
                                Going out of range during the test does not mean you 'failed', it just means we need to adjust our basal rate. 'but but but, isn't that just failure with extra steps?' 
                                You will quickly come to find that if you cannot give yourself grace, you will greatly struggle with this disease. 
                                So sure, if you want to view it through that lens yes, you failed. You're an abject failure.
                                Simply because you can't manually do the same thing that our bodies evolved to do over millions and millions of years, controlling the flow of several hormones from several different organs.
                                You need to do a better job of telling your liver to regulate glucagon, your adrenal glands to not dump so much cortisol, and gosh dangit just tell your immune system to get the heck out of your Islet of Langerhans and be cool for once!! 
                                <br/>
                                <br/>
                                Now that isn't exactly fair, is it? I bet you haven't even heard of the Islet of Langerhans before. I know I hadn't. 
                                <br/>
                                <br/>
                                The most common time to perform a basal rate test is overnight, as we generally fast while we sleep anyway. 
                                If you don't have a CGM, it is unfortunately important to wake up every 3-4 hours to test your blood glucose.
                                <br/>
                                <br/>
                                So you've performed the test.. now what?
                                <br/>
                                <br/>
                                Adjustments should be made incrementally, in 10% intervals (rounding up). What that means, is if you're taking between 1 and 15 units of basal insulin, you should raise or lower your dosage by 1 unit.
                                Between 16 and 25, raise or lower the dosage by 2. So on and so forth. It is recommended to use this new dosage for NO LESS than 3 days before performing another basal rate test. 
                                The amount of time required before you can accurately determine your basal rate is entirely based on the specific brand of insulin you use. 
                                I use Tresiba which is an ultra-long lasting insulin, and even though you could only wait three days, that's basically how long it takes for a single dosage of Tresiba to stabilize and I take it once a day, so for me to be able to see any change in my patterns I'd ideally wait atleast 5 days of the new dose.
                                It's important to remember that we generally have multiple basal dosages at once. 
                                This isn't what is referred to as stacking. This is so that we can maintain more stable levels for longer periods of times. 
                                Insulin stacking a basal dosage would be more like taking your dosage in the morning and then again at night.
                    ...
                    <div className="_content-block">
                        ...
                        <span>
                            <p>
                                ...
                                It's just a sign that we need to make a change in our diet.
                                <br/>
                                <br/> 
                                Eating a well balanced, satisfying, nourishing diet is how you are going to be able to eat without feeling guilt, and that's just true for everyone. 
                                But as a Diabetic, you'll see more stable blood sugar and hate your life less so that's cool too.
                                I'm going to really expand on this section over in the Dietary section of the site so I will paint with broader strokes to better cover what's important to know.
                                <br/>
                                <br/>
                                Your diet is important because your food is what provides your body with energy. What that food is made of determines how the body turns it into energy.
                                If it is a simple carbohydrate like glucose, sucrose, fructose or lactose, it is more bioavailable. 
                                That means the body is able to absorb it faster. Simple sugars will have a more profound effect on your blood sugar because they taken into the blood stream and cells faster.
                                <br/>
                                <br/>
                                In less fancy talk, simple sugars spike you hardest and fastest which is exactly why they're recommended for treating low events. 
                                If it is a complex carbohydrate like starches in rice, bread, pasta, cereal, etc.
                                The body needs to break down the larger chains of carbohydrates to make them accessible to the cells. 
                                The result of this is a slower but still profound effect on your blood sugar.
                                ...
                                <br/>
                                <br/>
                                In countries that have nutritional information laws, you will often find fiber listed under carbohydrates and that is because some fibers can be digestable.
                                ...
                                <br/>
                                <br/>
                                I will close this section off by saying that while sure there is research out there that suggest that certain foods have a positive effect on your blood sugars, like cinammon or even pomegranates.
